...
- **Sales Dashboard Project:** Building an interactive Power BI dashboard for sales performance tracking.  
- **Customer Segmentation:** Using Python & SQL to segment customers for targeted marketing campaigns.  
- **Data Visualization Tutorials:** Creating content on Tableau best practices for my YouTube channel.
